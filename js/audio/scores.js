 ...
 * then its tonal answer a fifth higher. Each statement is exactly eight beats (two bars),
 * so the answer enters on the bar line at 72 and hands over to the coda at 80.
 */
const TOCCATA_FUGUE = [].concat(
  line(64, [
    ['A4', 0.25, 0.8], ['G4', 0.25, 0.74], ['A4', 0.25, 0.82], [null, 0.25],
...
const PLUM_C = [].concat(
  ...
  figure(80, ['E6', 'D6', 'B5', 'G5', 'E5', 'G5', 'B5', 'E6'], 0.25, 8, 0.66, 0.5),
